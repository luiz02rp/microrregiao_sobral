...
A microrrgião de Sobral de 2024 a 2025 registrou `r mortes` mil mortes e `r vivos` mil nascidos vivos.

=> colocar um gráfico com a correlação entre os municípios com maior número de mortes 

=> depois disso, fazer uma apresentação das informações do gráfico nesse primeiro parágrafo
