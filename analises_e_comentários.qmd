...
#idade e sexo
pop_idade_sexo <- read.csv("data/pop_sexo_idade - Página1.csv",stringsAsFactors = FALSE)
```
...
pop_idade_sexo <- pop_idade_sexo |>
  mutate(
    jovens_total = as.numeric(jovens_total),
    idosos_total = as.numeric(idosos_total),
    pop_ativa_total = as.numeric(pop_ativa_total),
